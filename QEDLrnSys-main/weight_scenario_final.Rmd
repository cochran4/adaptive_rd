...
data <- NHANES[,c("RIDAGEYR", "RIAGENDR", "BPXSY1", "BPXDI1","BPQ050A", "LBXGLU", "LBDHDD", "LBXTR", "BMXBMI", "DIQ010", "DIQ175A", "BMXWT")]
...
data$wgt.s <- as.numeric(scale(data$BMXWT))
...
recalcutp <- function(reps=20, p =.5, s= 0) {
  ...
  ithpatient <- function(data, j){
    ...
    data$wgtchg <-ifelse(data$Afinal == 1, rnorm(3500, -5, 3), rnorm(3500, 0, 3))
...
result <- function(data
    ...
    glm1 <- tryCatch(lm(wgtchg ~ Afinal + riskfinal + riskfinal:Afinal, data = data, subset = rand==TRUE), error = function(e) return(NA))
   EST <- tryCatch(coef(glm1)["Afinal"], error = function(e) return(NA))
    ...
    Error <- tryCatch(EST-(-5), error = function(e) return(NA))
    #Errorlog <- tryCatch(coef(glm1)["Afinal"]-log(0.5), error = function(e) return(NA))
    Coverage <- tryCatch(between(-5, LB, UB), error = function(e) return(NA))
...
openxlsx::write.xlsx(rec.p.5s.0, file = "P:\\ED\\Analysis_Data\\Zayas-Caban_Patterson_Keeping_Patients\\R_runs\\wgttry.xlsx", sheetName = names(rec.p.5s.0), rowNames = FALSE)
rm(rec.p.5s.0)
...
names(rec.p.5s.0) <- c("p1500z0.5.r", "p2500z0.5.r", "p3500z0.5.r", "p1500z1.r", "p2500z1.r", "p3500z1.r", "p1500z1.5.r", "p2500z1.5.r", "p3500z1.5.r")
openxlsx::write.xlsx(rec.p.5s.0, file = "P:\\ED\\Analysis_Data\\Zayas-Caban_Patterson_Keeping_Patients\\R_runs\\rec.p.5s.0_wgtMErun1.xlsx", sheetName = names(rec.p.5s.0), rowNames = FALSE)
rm(rec.p.5s.0)
...
names(rec.p.5s.0) <- c("p1500z0.5.r", "p2500z0.5.r", "p3500z0.5.r", "p1500z1.r", "p2500z1.r", "p3500z1.r", "p1500z1.5.r", "p2500z1.5.r", "p3500z1.5.r")
openxlsx::write.xlsx(rec.p.5s.0, file = "P:\\ED\\Analysis_Data\\Zayas-Caban_Patterson_Keeping_Patients\\R_runs\\rec.p.5s.0_wgtMErun2.xlsx", sheetName = names(rec.p.5s.0), rowNames = FALSE)
rm(rec.p.5s.0)
...
names(rec.p.5s.0) <- c("p1500z0.5.r", "p2500z0.5.r", "p3500z0.5.r", "p1500z1.r", "p2500z1.r", "p3500z1.r", "p1500z1.5.r", "p2500z1.5.r", "p3500z1.5.r")
openxlsx::write.xlsx(rec.p.5s.0, file = "P:\\ED\\Analysis_Data\\Zayas-Caban_Patterson_Keeping_Patients\\R_runs\\rec.p.5s.0_wgtMErun3.xlsx", sheetName = names(rec.p.5s.0), rowNames = FALSE)
rm(rec.p.5s.0)
...
names(rec.p.5s.0) <- c("p1500z0.5.r", "p2500z0.5.r", "p3500z0.5.r", "p1500z1.r", "p2500z1.r", "p3500z1.r", "p1500z1.5.r", "p2500z1.5.r", "p3500z1.5.r")
openxlsx::write.xlsx(rec.p.5s.0, file = "P:\\ED\\Analysis_Data\\Zayas-Caban_Patterson_Keeping_Patients\\R_runs\\rec.p.5s.0_wgtMErun4.xlsx", sheetName = names(rec.p.5s.0), rowNames = FALSE)
rm(rec.p.5s.0)
...
names(rec.p.5s.0) <- c("p1500z0.5.r", "p2500z0.5.r", "p3500z0.5.r", "p1500z1.r", "p2500z1.r", "p3500z1.r", "p1500z1.5.r", "p2500z1.5.r", "p3500z1.5.r")
openxlsx::write.xlsx(rec.p.5s.0, file = "P:\\ED\\Analysis_Data\\Zayas-Caban_Patterson_Keeping_Patients\\R_runs\\rec.p.5s.0_wgtMErun5.xlsx", sheetName = names(rec.p.5s.0), rowNames = FALSE)
rm(rec.p.5s.0)
...
names(rec.p.5s.0) <- c("p1500z0.5.r", "p2500z0.5.r", "p3500z0.5.r", "p1500z1.r", "p2500z1.r", "p3500z1.r", "p1500z1.5.r", "p2500z1.5.r", "p3500z1.5.r")
openxlsx::write.xlsx(rec.p.5s.0, file = "P:\\ED\\Analysis_Data\\Zayas-Caban_Patterson_Keeping_Patients\\R_runs\\rec.p.5s.0_wgtMErun6.xlsx", sheetName = names(rec.p.5s.0), rowNames = FALSE)
rm(rec.p.5s.0)
...
names(rec.p.5s.0) <- c("p1500z0.5.r", "p2500z0.5.r", "p3500z0.5.r", "p1500z1.r", "p2500z1.r", "p3500z1.r", "p1500z1.5.r", "p2500z1.5.r", "p3500z1.5.r")
openxlsx::write.xlsx(rec.p.5s.0, file = "P:\\ED\\Analysis_Data\\Zayas-Caban_Patterson_Keeping_Patients\\R_runs\\rec.p.5s.0_wgtMErun7.xlsx", sheetName = names(rec.p.5s.0), rowNames = FALSE)
rm(rec.p.5s.0)
...
names(rec.p.5s.0) <- c("p1500z0.5.r", "p2500z0.5.r", "p3500z0.5.r", "p1500z1.r", "p2500z1.r", "p3500z1.r", "p1500z1.5.r", "p2500z1.5.r", "p3500z1.5.r")
openxlsx::write.xlsx(rec.p.5s.0, file = "P:\\ED\\Analysis_Data\\Zayas-Caban_Patterson_Keeping_Patients\\R_runs\\rec.p.5s.0_wgtMErun8.xlsx", sheetName = names(rec.p.5s.0), rowNames = FALSE)
rm(rec.p.5s.0)
...
names(rec.p.5s.0) <- c("p1500z0.5.r", "p2500z0.5.r", "p3500z0.5.r", "p1500z1.r", "p2500z1.r", "p3500z1.r", "p1500z1.5.r", "p2500z1.5.r", "p3500z1.5.r")
openxlsx::write.xlsx(rec.p.5s.0, file = "P:\\ED\\Analysis_Data\\Zayas-Caban_Patterson_Keeping_Patients\\R_runs\\rec.p.5s.0_wgtMErun9.xlsx", sheetName = names(rec.p.5s.0), rowNames = FALSE)
rm(rec.p.5s.0)
...
names(rec.p.5s.0) <- c("p1500z0.5.r", "p2500z0.5.r", "p3500z0.5.r", "p1500z1.r", "p2500z1.r", "p3500z1.r", "p1500z1.5.r", "p2500z1.5.r", "p3500z1.5.r")
openxlsx::write.xlsx(rec.p.5s.0, file = "P:\\ED\\Analysis_Data\\Zayas-Caban_Patterson_Keeping_Patients\\R_runs\\rec.p.5s.0_wgtMErun10.xlsx", sheetName = names(rec.p.5s.0), rowNames = FALSE)
rm(rec.p.5s.0)
```
...
data$wgtchg <- ifelse(data$Afinal == 1, rnorm(3500, -5, 3), 0)
...
result <- function(data
    ...
    n <- tryCatch(table(data$rand)["TRUE"], error = function(e) return(NA))
    glm1 <- tryCatch(lm(wgtchg ~ Afinal + riskfinal + riskfinal:Afinal, data = data, subset = rand==TRUE), error = function(e) return(NA))
    ME <- tryCatch(marginaleffects(glm1, variables = "Afinal"), error = function(e) return(NA))
   EST <- tryCatch(summary(ME)[[3]], error = function(e) return(NA))
    LB <- tryCatch(summary(ME)[[7]], error = function(e) return(NA))
    UB <- tryCatch(summary(ME)[[8]], error = function(e) return(NA))
    Error <- tryCatch(EST-(-5), error = function(e) return(NA))
    #Errorlog <- tryCatch(coef(glm1)["Afinal"]-log(0.5), error = function(e) return(NA))
    Coverage <- tryCatch(between(-5, LB, UB), error = function(e) return(NA))
...
openxlsx::write.xlsx(rev.p.5s.5, file = "P:\\ED\\Analysis_Data\\Zayas-Caban_Patterson_Keeping_Patients\\R_runs\\rev.p.5s.5_weight.xlsx", sheetName = names(rev.p.5s.5), rowNames = FALSE)
rm(rev.p.5s.5)
```
